      ...
      <div class="bg-secondary">
        ...
        <table class="table table-borderless">
          ...
          <tbody>
            ...
            <tr>
              <td><h4 class="alert alert-info">All sent transactions</h4> </td>
              <td> :</td>
              <td><h4 class=" alert alert-info">{{$total_tranx}}</h4></td>
            </tr>
            <tr>
              <td> <h4 class="alert alert-info">All successful transaction</h4></td>
              <td> :</td>
              <td> <h4 class="alert alert-info" >{{$all_succ_trax_count}}</h4></td>
            </tr>
            <tr>
              <td> <h4 class="alert alert-info">All failed transaction </h4></td>
              <td> :</td>
